...
if __name__ == '__main__':
    ...
    output_file = '/eos/home-o/oknapp/opendata_v2/wdytt_mix.hdf5'
    ...
    data_files = [base_dir + '7719/data.hdf5',  # DY1
                  ...
                  base_dir + '9588/data.hdf5']  # ttbar

    xsec = np.array([561, 181, 51.1, 15, 4480, 1435, 304.2, 164])
    k = np.array([1.23, 1.23, 1.23, 1.23, 1.23, 1.23, 1.23, 1.66])
    fraction = xsec * k / np.sum(xsec * k)
